-- CS4400: Introduction to Database Systems: Thursday, July 13, 2023
-- SQL Autograding Environment (v19): Global Company Database (MINI-EXAM #5) [SHELL]
...
SELECT pname AS project_name, 
       ...
       title AS operation_title 
FROM project 
JOIN operations ON project.pnumber = operations.pnumber 
WHERE team_size > 2;

create or replace view practiceQuery11 as
SELECT pname, project.pnumber, plocation, dnum
FROM project
JOIN operations ON project.pnumber = operations.pnumber
WHERE team_size = (SELECT MIN(team_size) FROM operations);
...
WHERE pno IN (
    SELECT operations.pnumber
    FROM operations
    JOIN operation_skills ON operations.pnumber = operation_skills.pnumber
    GROUP BY operations.pnumber
    HAVING COUNT(skill_name) > 3
);

create or replace view practiceQuery22 as
SELECT o.title AS Operation_Title
FROM operations AS o
WHERE o.title LIKE '%crypto%' OR o.title LIKE '%cloud%'

UNION

SELECT os.skill_name AS Skill_Name
FROM operation_skills AS os
WHERE os.skill_name LIKE '%crypto%' OR os.skill_name LIKE '%cloud%'

UNION

SELECT a.title AS Analysis_Title
FROM analysis AS a
WHERE a.title LIKE '%crypto%' OR a.title LIKE '%cloud%';

create or replace view practiceQuery16 as
SELECT fname, 
       lname, 
...
JOIN interns_in ON dependent.essn = interns_in.essn AND dependent.dependent_name = interns_in.dependent_name
WHERE rating > 7;
...
GROUP BY salary
HAVING COUNT(salary) = (
    SELECT COUNT(salary) AS most_frequent
    FROM employee
    GROUP BY salary
...
create or replace view practiceQuery29 as 
...
LEFT JOIN operations ON project.pnumber = operations.pnumber
LEFT JOIN operation_skills ON operations.pnumber = operation_skills.pnumber
WHERE skill_name NOT LIKE '%data%' OR skill_name IS NULL;
...
(0,10,'123456789##############'),
(0,10,'333445555##############'),
(0,11,'producty#2#sugarland#5###########'),
(0,11,'newbenefits#30#stafford#4###########'),
(0,12,'john#smith#30000#1#32.5##########'),
(0,12,'franklin#wong#40000#10#10.0##########'),
(0,12,'joyce#english#25000#1#20.0##########'),
(0,12,'ahmad#jabbar#25000#10#35.0##########'),
(0,12,'alicia#zelaya#25000#10#10.0##########'),
(0,13,'4#administration#computerization############'),
(0,13,'1#headquarters#reorganization############'),
(0,14,'john#smith#731fondren,houstontx#michael#8##########'),
(0,14,'john#smith#731fondren,houstontx#alice#8##########'),
(0,14,'franklin#wong#638voss,houstontx#alice#10##########'),
(0,14,'joyce#english#5631rice,houstontx############'),
(0,14,'ramesh#narayan#975fireoak,humbletx############'),
(0,14,'james#borg#450stone,houstontx############'),
(0,14,'jennifer#wallace#291berry,bellairetx############'),
(0,14,'ahmad#jabbar#980dallas,houstontx############'),
(0,14,'alicia#zelaya#3321castle,springtx############'),
(0,15,'3##############'),
(0,16,'john#smith#alice#8###########'),
(0,16,'john#smith#michael#8###########'),
(0,16,'franklin#wong#alice#10###########'),
(0,17,'5##############'),
(0,18,'2#10000#secondnationalbank#350000###########'),
(0,18,'3#27000#tempestbank#200000###########'),
(0,18,'5#31000#############'),
(0,18,'7#16000#power,water&copper############'),
(0,18,'11#6000#cumuluscloudcomputing#380000###########'),
(0,18,'17#61000#############'),
(0,18,'23#24000#creditunionuniversal#417000###########'),
(0,19,'5#research#productx############'),
(0,19,'4#administration#computerization############'),
(0,20,'jennifer#wallace#43000#30#20.0##########'),
(0,20,'ahmad#jabbar#25000#30#5.0##########'),
(0,20,'alicia#zelaya#25000#30#30.0##########'),
(0,21,'ramesh#narayan#666884444#1962-09-15#975fireoak,humbletx#m#38000#333445555#5######'),
(0,22,'cryptocurrencycorrelation##############'),
(0,22,'cloudconversion##############'),
(0,22,'cryptomonitoring##############'),
(0,22,'cloudcomputing##############'),
(0,23,'computerization#stafford#dronetrafficcontrol############'),
(0,23,'reorganization#houston#cloudconversion############'),
(0,24,'productx#1#bellaire#5###########'),
(0,24,'producty#2#sugarland#5###########'),
(0,24,'productz#3#houston#5###########'),
(0,24,'computerization#10#stafford#4###########'),
(0,24,'newbenefits#30#stafford#4###########'),
(0,25,'5#research#producty############'),
(0,26,'3##############'),
(0,27,'29##############'),
(0,27,'13##############'),
(0,27,'17##############'),
(0,28,'john#smith#30000#1#32.5##########'),
(0,28,'franklin#wong#40000#3#10.0##########'),
(0,28,'joyce#english#25000#1#20.0##########'),
(0,28,'ramesh#narayan#38000#3#40.0##########'),
(0,29,'1#productx#5############'),
(0,29,'2#producty#5#financialanalysis###########'),
(0,29,'3#productz#5############'),
(0,29,'10#computerization#4#dronepiloting###########'),
(0,29,'10#computerization#4#real-timeoperatingsystems###########'),
(0,29,'10#computerization#4#wirelessnetworking###########'),
(0,29,'20#reorganization#1#cloudcomputing###########'),
(0,29,'30#newbenefits#4#financialanalysis###########'),
(0,29,'30#newbenefits#4#patternmining###########'),
(0,30,'productx#bellaire#intranet#4###########'),
(0,30,'producty#sugarland#none#1###########'),
(0,30,'producty#sugarland#intranet#10###########'),
(0,30,'computerization#stafford#open#20###########'),
(1,10,'888665555##############'),
(1,10,'666884444##############'),
(1,10,'123456789##############'),
(1,10,'333445555##############'),
(1,11,'producty#2#sugarland#5###########'),
(1,12,'john#smith#30000#1#32.5##########'),
(1,12,'joyce#english#25000#1#20.0##########'),
(1,13,'1#headquarters#reorganization############'),
(1,14,'john#smith#731fondren,houstontx#michael#8##########'),
(1,14,'franklin#wong#638voss,houstontx#alice#10##########'),
(1,14,'joyce#english#5631rice,houstontx############'),
(1,14,'ramesh#narayan#975fireoak,humbletx############'),
(1,14,'james#borg#450stone,houstontx############'),
(1,15,'1##############'),
(1,16,'john#smith#michael#8###########'),
(1,16,'franklin#wong#alice#10###########'),
(1,17,'3##############'),
(1,18,'2#10000#secondnationalbank#350000###########'),
(1,18,'3#27000#tempestbank#200000###########'),
(1,18,'5#31000#############'),
(1,18,'7#16000#power,water&copper############'),
(1,18,'23#24000#creditunionuniversal#417000###########'),
(1,19,'5#research#productx############'),
(1,21,'ramesh#narayan#666884444#1962-09-15#975fireoak,humbletx#m#38000#333445555#5######'),
(1,22,'cloudconversion##############'),
(1,22,'cloudcomputing##############'),
(1,23,'reorganization#houston#cloudconversion############'),
(1,24,'productx#1#bellaire#5###########'),
(1,24,'producty#2#sugarland#5###########'),
(1,24,'productz#3#houston#5###########'),
(1,25,'5#research#producty############'),
(1,26,'2##############'),
(1,28,'john#smith#30000#1#32.5##########'),
(1,28,'franklin#wong#40000#3#10.0##########'),
(1,28,'joyce#english#25000#1#20.0##########'),
(1,28,'ramesh#narayan#38000#3#40.0##########'),
(1,29,'1#productx#5############'),
(1,29,'2#producty#5#financialanalysis###########'),
(1,29,'3#productz#5############'),
(1,29,'20#reorganization#1#cloudcomputing###########'),
(1,30,'productx#bellaire#intranet#4###########'),
(1,30,'producty#sugarland#none#1###########'),
(1,30,'producty#sugarland#intranet#10###########'),
(2,10,'888665555##############'),
(2,10,'987654321##############'),
(2,11,'newbenefits#30#stafford#4###########'),
(2,12,'ahmad#jabbar#25000#10#35.0##########'),
(2,12,'alicia#zelaya#25000#10#10.0##########'),
(2,13,'4#administration#computerization############'),
(2,13,'1#headquarters#reorganization############'),
(2,14,'james#borg#450stone,houstontx############'),
(2,14,'jennifer#wallace#291berry,bellairetx############'),
(2,14,'ahmad#jabbar#980dallas,houstontx############'),
(2,14,'alicia#zelaya#3321castle,springtx############'),
(2,15,'2##############'),
(2,17,'2##############'),
(2,18,'11#6000#cumuluscloudcomputing#380000###########'),
(2,18,'17#61000#############'),
(2,18,'23#24000#creditunionuniversal#417000###########'),
(2,19,'4#administration#computerization############'),
(2,20,'jennifer#wallace#43000#30#20.0##########'),
(2,20,'ahmad#jabbar#25000#30#5.0##########'),
(2,20,'alicia#zelaya#25000#30#30.0##########'),
(2,21,'jennifer#wallace#987654321#1941-06-20#291berry,bellairetx#f#43000#888665555#4######'),
(2,22,'cryptocurrencycorrelation##############'),
(2,22,'cloudconversion##############'),
(2,22,'cryptomonitoring##############'),
(2,22,'cloudcomputing##############'),
(2,23,'computerization#stafford#dronetrafficcontrol############'),
(2,23,'reorganization#houston#cloudconversion############'),
(2,24,'computerization#10#stafford#4###########'),
(2,24,'newbenefits#30#stafford#4###########'),
(2,26,'1##############'),
(2,27,'29##############'),
(2,27,'13##############'),
(2,29,'10#computerization#4#dronepiloting###########'),
(2,29,'10#computerization#4#real-timeoperatingsystems###########'),
(2,29,'10#computerization#4#wirelessnetworking###########'),
(2,29,'20#reorganization#1#cloudcomputing###########'),
(2,29,'30#newbenefits#4#financialanalysis###########'),
(2,29,'30#newbenefits#4#patternmining###########'),
(2,30,'computerization#stafford#open#20###########'),
(3,10,'888665555##############'),
(3,10,'378990405##############'),
(3,10,'987654321##############'),
(3,10,'701294005##############'),
...
(3,10,'123456789##############'),
(3,10,'333445555##############'),
(3,11,'producty#2#sugarland#5###########'),
(3,11,'newbenefits#30#stafford#4###########'),
(3,12,'john#smith#30000#1#32.5##########'),
(3,12,'camila#jackson#37000#55#35.0##########'),
(3,12,'hector#cuevas#31000#55#10.0##########'),
(3,12,'franklin#wong#40000#10#10.0##########'),
(3,12,'joyce#english#25000#1#20.0##########'),
(3,12,'alicia#smith#51000#55#20.0##########'),
(3,12,'ahmad#jabbar#25000#10#35.0##########'),
(3,12,'alicia#zelaya#25000#10#10.0##########'),
(3,13,'4#administration#computerization############'),
(3,13,'1#headquarters#reorganization############'),
(3,13,'9#reverseengineering#hindsight############'),
(3,14,'john#smith#731fondren,houstontx#alice#8##########'),
(3,14,'john#smith#731fondren,houstontx#michael#8##########'),
(3,14,'camila#jackson#3830stellarfruit,tulsaok############'),
(3,14,'hector#cuevas#107fivefingerway,dallastx############'),
(3,14,'franklin#wong#638voss,houstontx#alice#10##########'),
(3,14,'heike#weiss#219zoopalast,normanok#ariel#8##########'),
(3,14,'heike#weiss#219zoopalast,normanok#ariel#8##########'),
(3,14,'joyce#english#5631rice,houstontx############'),
(3,14,'hiroto#watanabe#606springtail,houstontx############'),
(3,14,'ramesh#narayan#975fireoak,humbletx############'),
(3,14,'alicia#smith#2teleport,dallastx############'),
(3,14,'james#borg#450stone,houstontx############'),
(3,14,'jennifer#wallace#291berry,bellairetx############'),
(3,14,'ahmad#jabbar#980dallas,houstontx############'),
(3,14,'alicia#zelaya#3321castle,springtx############'),
(3,15,'3##############'),
(3,16,'john#smith#alice#8###########'),
(3,16,'john#smith#michael#8###########'),
(3,16,'franklin#wong#alice#10###########'),
(3,16,'heike#weiss#ariel#8###########'),
(3,16,'heike#weiss#ariel#8###########'),
(3,17,'6##############'),
(3,18,'2#10000#secondnationalbank#350000###########'),
(3,18,'3#27000#tempestbank#200000###########'),
(3,18,'5#31000#############'),
(3,18,'7#16000#power,water&copper############'),
(3,18,'11#6000#cumuluscloudcomputing#380000###########'),
(3,18,'17#61000#############'),
(3,18,'23#24000#creditunionuniversal#417000###########'),
(3,18,'31#66000#############'),
(3,18,'37#29000#shelloil&gas#415000###########'),
(3,19,'5#research#productx############'),
(3,19,'4#administration#computerization############'),
(3,19,'9#reverseengineering#hindsight############'),
(3,20,'jennifer#wallace#43000#30#20.0##########'),
(3,20,'ahmad#jabbar#25000#30#5.0##########'),
(3,20,'alicia#zelaya#25000#30#30.0##########'),
(3,21,'alicia#smith#701294005#1967-03-19#2teleport,dallastx#f#51000#235711131#9######'),
(3,22,'cryptocurrencycorrelation##############'),
(3,22,'cloudconversion##############'),
(3,22,'cryptomonitoring##############'),
(3,22,'cloudcomputing##############'),
(3,23,'computerization#stafford#dronetrafficcontrol############'),
(3,23,'reorganization#houston#cloudconversion############'),
(3,23,'hindsight#dallas#dataflowgraphanalysis############'),
(3,24,'productx#1#bellaire#5###########'),
(3,24,'producty#2#sugarland#5###########'),
(3,24,'productz#3#houston#5###########'),
(3,24,'computerization#10#stafford#4###########'),
(3,24,'newbenefits#30#stafford#4###########'),
(3,24,'hindsight#55#dallas#9###########'),
(3,25,'5#research#producty############'),
(3,26,'3##############'),
(3,27,'29##############'),
(3,27,'13##############'),
(3,27,'17##############'),
(3,28,'john#smith#30000#1#32.5##########'),
(3,28,'franklin#wong#40000#3#10.0##########'),
(3,28,'joyce#english#25000#1#20.0##########'),
(3,28,'ramesh#narayan#38000#3#40.0##########'),
(3,29,'1#productx#5############'),
(3,29,'2#producty#5#financialanalysis###########'),
(3,29,'3#productz#5############'),
(3,29,'10#computerization#4#dronepiloting###########'),
(3,29,'10#computerization#4#real-timeoperatingsystems###########'),
(3,29,'10#computerization#4#wirelessnetworking###########'),
(3,29,'20#reorganization#1#cloudcomputing###########'),
(3,29,'30#newbenefits#4#financialanalysis###########'),
(3,29,'30#newbenefits#4#patternmining###########'),
(3,30,'productx#bellaire#intranet#4###########'),
(3,30,'producty#sugarland#none#1###########'),
(3,30,'producty#sugarland#intranet#10###########'),
(3,30,'computerization#stafford#open#20###########'),
(4,10,'888665555##############'),
(4,10,'987654321##############'),
(4,10,'666884444##############'),
(4,10,'123456789##############'),
(4,10,'333445555##############'),
(4,11,'producty#2#sugarland#5###########'),
(4,11,'newbenefits#30#stafford#4###########'),
(4,12,'john#smith#36000#1#44.5##########'),
(4,12,'franklin#wong#37000#10#13.0##########'),
(4,12,'joyce#english#25000#1#30.5##########'),
(4,12,'ahmad#jabbar#34000#10#41.0##########'),
(4,12,'alicia#zelaya#31000#10#10.0##########'),
(4,13,'4#administration#computerization############'),
(4,13,'1#headquarters#reorganization############'),
(4,14,'john#smith#731fondren,houstontx#michael#8##########'),
(4,14,'john#smith#731fondren,houstontx#alice#8##########'),
(4,14,'franklin#wong#638voss,houstontx#alice#8##########'),
(4,14,'joyce#english#5631rice,houstontx############'),
(4,14,'ramesh#narayan#975fireoak,humbletx############'),
(4,14,'james#borg#450stone,houstontx############'),
(4,14,'jennifer#wallace#291berry,bellairetx############'),
(4,14,'ahmad#jabbar#980dallas,houstontx############'),
(4,14,'alicia#zelaya#3321castle,springtx############'),
(4,15,'1##############'),
(4,16,'john#smith#alice#8###########'),
(4,16,'john#smith#michael#8###########'),
(4,16,'franklin#wong#alice#8###########'),
(4,17,'5##############'),
(4,18,'2#6000#secondnationalbank#360000###########'),
(4,18,'3#19000#tempestbank#220000###########'),
(4,18,'5#29000#############'),
(4,18,'7#12000#power,water&copper############'),
(4,18,'11#0#cumuluscloudcomputing#370000###########'),
(4,18,'17#59000#############'),
(4,18,'23#25000#creditunionuniversal#417000###########'),
(4,19,'5#research#productx############'),
(4,19,'4#administration#computerization############'),
(4,20,'jennifer#wallace#46000#30#24.5##########'),
(4,20,'ahmad#jabbar#34000#30#5.0##########'),
(4,20,'alicia#zelaya#31000#30#31.5##########'),
(4,21,'ramesh#narayan#666884444#1962-09-15#975fireoak,humbletx#m#38000#333445555#5######'),
(4,22,'cryptocurrencycorrelation##############'),
(4,22,'cloudconversion##############'),
(4,22,'cryptomonitoring##############'),
(4,22,'cloudcomputing##############'),
(4,23,'computerization#stafford#dronetrafficcontrol############'),
(4,23,'reorganization#houston#cloudconversion############'),
(4,24,'productx#1#bellaire#5###########'),
(4,24,'producty#2#sugarland#5###########'),
(4,24,'productz#3#houston#5###########'),
(4,24,'computerization#10#stafford#4###########'),
(4,24,'newbenefits#30#stafford#4###########'),
(4,25,'5#research#producty############'),
(4,26,'2##############'),
(4,27,'29##############'),
(4,27,'13##############'),
(4,27,'17##############'),
(4,28,'john#smith#36000#1#44.5##########'),
(4,28,'franklin#wong#37000#3#14.5##########'),
(4,28,'joyce#english#25000#1#30.5##########'),
(4,28,'ramesh#narayan#38000#3#49.0##########'),
(4,29,'1#productx#5############'),
(4,29,'2#producty#5#financialanalysis###########'),
(4,29,'3#productz#5############'),
(4,29,'10#computerization#4#dronepiloting###########'),
(4,29,'10#computerization#4#real-timeoperatingsystems###########'),
(4,29,'10#computerization#4#wirelessnetworking###########'),
(4,29,'20#reorganization#1#cloudcomputing###########'),
(4,29,'30#newbenefits#4#financialanalysis###########'),
(4,29,'30#newbenefits#4#patternmining###########'),
(4,30,'producty#sugarland#none#1###########');
