...
create or replace view practiceQuery40 as
select 'Hello World!';

create or replace view practiceQuery41 as 
select 'Hello World!' as 'greeting';

create or replace view practiceQuery42 as
select 4 + 6;

create or replace view practiceQuery43 as 
...
from employee
where bdate > '1968-1-1';

create or replace view practiceQuery66 as
select fname, lname, address, bdate
from employee
where bdate > '1964-1-1' and bdate < '1970-8-10';
...
select fname, lname, address
from employee
where lname like '%aya%' and not lname like '%aya';

create or replace view practiceQuery80 as
select fname, lname, salary * 1.100000000 as 'raise'
from employee
where dno = 5;
