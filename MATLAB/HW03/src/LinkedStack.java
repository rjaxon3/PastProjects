...
public class LinkedStack<T> {
    ...
    public void push(T data) {
        if (data == null) {
            throw new IllegalArgumentException("The data inputted is null and cannot be added!");
        }
    ...
    public T peek() {
        if (size == 0) {
            throw new NoSuchElementException("The stack is empty! There is nothing to peek at!");
        } else {
