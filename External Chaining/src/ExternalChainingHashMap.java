...
public class ExternalChainingHashMap<K, V> {
    ...
    public V put(K key, V value) {
        if (key == null || value == null) {
            ...
            if (value == null) {
                throw new IllegalArgumentException("The value entered is null!");
            }
        }
        ...
        if (table[hashnumber] == null) {
            table[hashnumber] = new ExternalChainingMapEntry<K, V>(key, value);
        } else {
            V old;
            ExternalChainingMapEntry<K, V> check = table[hashnumber];
            ...
            ExternalChainingMapEntry<K, V> node = new ExternalChainingMapEntry(key, value, table[hashnumber]);
            table[hashnumber] = node;
        }
        size++;
        return null;
    }
    ...
    public V remove(K key) {
        ...
        int hashnumber = Math.abs(key.hashCode() % table.length);
        if (table[hashnumber] == null) {
            throw new java.util.NoSuchElementException("The key does not exist is Hashmap!");
        } else {
            ExternalChainingMapEntry<K, V> check = table[hashnumber];
            if (check.getKey().equals(key)) {
    ...
    public V get(K key) {
        if (key == null) {
            throw new IllegalArgumentException("Key entered is null!");
        }
        int hashnumber = Math.abs(key.hashCode() % table.length);
        if (table[hashnumber] == null) {
            throw new java.util.NoSuchElementException("The key does not exist!");
    ...
    public void resizeBackingTable(int length) {
        if (length < size || length < 0) {
            if (length < size) {
                throw new java.lang.IllegalArgumentException("The length entered is less than amount in HashMap!");
            }
            if (length < 0) {
                throw new java.lang.IllegalArgumentException("The length entered is a negative number!");
            }
        }
        ExternalChainingMapEntry<K, V> temp;
        int tempsize = size;
