...
public class PongJaxon2 extends Canvas implements KeyListener, Runnable
{
	private BlinkyBallJaxon ball;
	...
	public PongJaxon2()
   {
      ...
      //instantiate a Ball
		ball = new BlinkyBallJaxon(400,100,10,10,Color.BLUE,1,1);
