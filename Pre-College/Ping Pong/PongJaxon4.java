...
public class PongJaxon4 extends Canvas implements KeyListener, Runnable
{
	private SpeedUpBallJaxon ball;
	...
	public PongJaxon4()
   {
      ...
      //instantiate a Ball
		ball = new SpeedUpBallJaxon(400,100,10,10,Color.BLUE,1,1);
