...
public class PongJaxon3 extends Canvas implements KeyListener, Runnable
{
	private InvisibleBallJaxon ball;
	...
	public PongJaxon3()
   {
      ...
      //instantiate a Ball
		ball = new InvisibleBallJaxon(400,100,10,10,Color.BLUE,1,1);
