-- CS4400: Introduction to Database Systems: Thursday, September 7, 2023
-- SQL Autograding Environment (v19): Global Company Database (MINI-EXAM #1)
...
select fsid as 'fund_source_identifier', pnumber as 'project_number'
from fund_source
where remaining >= 18 * usage_rate;

create or replace view practiceQuery10 as
select fsid as 'source_identifier', remaining as 'remaining_assets', usage_rate as 'rate_of_use'
from fund_source
where remaining >= 21000 and usage_rate < 2000 or (remaining <= 9000 and usage_rate >= 1000);

create or replace view practiceQuery32 as
select company as 'customers_name', assets as 'asset_values', fsid as 'fund_source_identifier'
from customer
where company like '%e%r%e%r';

create or replace view practiveQuery13 as
select pnumber as 'project_number', fsid, usage_rate, remaining
from fund_source
where usage_rate < 5000;

create or replace view practiveQuery25 as
select ssn as 'employee_identifier', start_hour as 'session_start', duration as 'session_duration'
from time_frames
where start_hour + duration <= 24;

create or replace view practiveQuery15 as
select pnumber, fsid, usage_rate, remaining
from fund_source
where usage_rate > 1000;

create or replace view practiveQuery34 as
select fsid as 'source_identifier', remaining as 'remaining_assets', usage_rate as 'rate_of_use'
from fund_source
where remaining <= 24000 and usage_rate >= 2000 or (remaining >= 27000 and usage_rate < 3000);

create or replace view practiveQuery29 as
select pnumber, min(frequency), max(frequency)
from maintenance_types
where cost >= 500
group by pnumber;

create or replace view practiveQuery22 as
select pnumber, frequency, cost as 'maintenance_cost'
from maintenance_types
where remote_access like 'open' or remote_access like 'vpn';
...
(0,11,'2#1#1000#27000###########'),
(0,11,'3#1#1000#16000###########'),
(0,11,'10#2#1000#15000###########'),
(0,11,'20#1#3000#24000###########'),
(0,11,'30#1#1000#21000###########'),
(0,12,'1#1#1000#10000###########'),
(0,12,'2#2#2000#58000###########'),
(0,12,'3#1#1000#16000###########'),
(0,12,'10#2#5000#70000###########'),
(0,12,'20#1#3000#24000###########'),
(0,12,'30#1#1000#21000###########'),
(0,13,'1#1#1000#10000###########'),
(0,13,'2#2#2000#58000###########'),
(0,13,'3#1#1000#16000###########'),
(0,13,'10#2#2000#15000###########'),
(0,13,'20#1#3000#24000###########'),
(0,13,'30#1#1000#21000###########'),
(0,14,'1#1#1000#10000###########'),
(0,14,'2#2#1000#58000###########'),
(0,14,'3#1#1000#16000###########'),
(0,14,'10#2#1000#15000###########'),
(0,14,'20#1#3000#24000###########'),
(0,14,'30#1#1000#21000###########'),
(0,15,'2#1#2000#31000###########'),
(0,15,'10#2#2000#70000###########'),
(0,15,'20#1#3000#24000###########'),
(0,16,'1#1#1000#10000###########'),
(0,16,'2#1#1000#27000###########'),
(0,16,'3#1#1000#16000###########'),
(0,16,'10#1#1000#6000###########'),
(0,16,'30#1#1000#21000###########'),
(0,17,'alice#123456789#8############'),
(0,17,'michael#123456789#6############'),
(0,18,'alice#123456789#4############'),
(0,18,'michael#123456789#5############'),
(0,18,'alice#333445555#5############'),
(0,19,'10#1#170000############'),
(0,19,'0#5#516000############'),
(0,20,'tech3#houston#850000############'),
(0,21,'bank2#tempestbank#200000#3###########'),
(0,21,'bank3#creditunionuniversal#417000#23###########'),
(0,22,'1#12#100############'),
(0,22,'2#30#100############'),
(0,22,'10#4#400############'),
(0,22,'10#20#100############'),
(0,23,'1#12#100############'),
(0,23,'10#4#400############'),
(0,24,'10#dronetrafficcontrol#############'),
(0,24,'20#cloudconversion#############'),
(0,25,'666884444#13#9############'),
(0,25,'888665555#15#4############'),
(0,25,'987654321#11#4############'),
(0,26,'3#2#############'),
...
(0,29,'1#4#12############'),
(0,29,'2#1#30############'),
(0,30,'bank3#newyork#23############'),
(0,30,'mgmt1#dallas#7############'),
(0,30,'tech2##11############'),
(0,31,'bank1#dallas#350000############'),
(0,31,'mgmt1#dallas#############'),
(0,31,'tech2##380000############'),
(0,32,'anytimeanywherecrypto#619000#29############'),
(0,32,'power,water&copper##7############'),
(0,33,'2#10000#1000############'),
(0,33,'7#16000#1000############'),
(0,33,'11#6000#1000############'),
(0,33,'17#61000#5000############'),
...
(1,11,'2#1#1000#27000###########'),
(1,11,'3#1#1000#16000###########'),
(1,11,'20#1#3000#24000###########'),
(1,12,'1#1#1000#10000###########'),
(1,12,'2#2#2000#58000###########'),
(1,12,'3#1#1000#16000###########'),
(1,12,'20#1#3000#24000###########'),
(1,13,'1#1#1000#10000###########'),
(1,13,'2#2#2000#58000###########'),
(1,13,'3#1#1000#16000###########'),
(1,13,'20#1#3000#24000###########'),
(1,14,'1#1#1000#10000###########'),
(1,14,'2#2#1000#58000###########'),
(1,14,'3#1#1000#16000###########'),
(1,14,'20#1#3000#24000###########'),
(1,15,'2#1#2000#31000###########'),
(1,15,'20#1#3000#24000###########'),
(1,16,'1#1#1000#10000###########'),
(1,16,'2#1#1000#27000###########'),
(1,16,'3#1#1000#16000###########'),
(1,18,'michael#123456789#5############'),
(1,18,'alice#333445555#5############'),
(1,19,'10#1#170000############'),
(1,21,'bank2#tempestbank#200000#3###########'),
(1,21,'bank3#creditunionuniversal#417000#23###########'),
(1,22,'1#12#100############'),
(1,22,'2#30#100############'),
(1,23,'1#12#100############'),
(1,24,'20#cloudconversion#############'),
(1,25,'666884444#13#9############'),
(1,25,'888665555#15#4############'),
(1,26,'3#2#############'),
(1,27,'2#100#2000############'),
...
(1,29,'1#4#12############'),
(1,29,'2#1#30############'),
(1,30,'bank3#newyork#23############'),
(1,30,'mgmt1#dallas#7############'),
(1,31,'bank1#dallas#350000############'),
(1,31,'mgmt1#dallas#############'),
(1,32,'power,water&copper##7############'),
(1,33,'2#10000#1000############'),
(1,33,'7#16000#1000############'),
(1,34,'3#27000#1000############'),
(1,34,'5#31000#2000############'),
...
(2,10,'13#9000#2000############'),
(2,10,'29#21000#1000############'),
(2,11,'10#2#1000#15000###########'),
(2,11,'20#1#3000#24000###########'),
(2,11,'30#1#1000#21000###########'),
(2,12,'10#2#5000#70000###########'),
(2,12,'20#1#3000#24000###########'),
(2,12,'30#1#1000#21000###########'),
(2,13,'10#2#2000#15000###########'),
(2,13,'20#1#3000#24000###########'),
(2,13,'30#1#1000#21000###########'),
(2,14,'10#2#1000#15000###########'),
(2,14,'20#1#3000#24000###########'),
(2,14,'30#1#1000#21000###########'),
(2,15,'10#2#2000#70000###########'),
(2,15,'20#1#3000#24000###########'),
(2,16,'10#1#1000#6000###########'),
(2,16,'30#1#1000#21000###########'),
(2,20,'tech3#houston#850000############'),
(2,21,'bank3#creditunionuniversal#417000#23###########'),
(2,22,'10#4#400############'),
(2,22,'10#20#100############'),
(2,23,'10#4#400############'),
(2,24,'10#dronetrafficcontrol#############'),
(2,24,'20#cloudconversion#############'),
(2,25,'888665555#15#4############'),
(2,25,'987654321#11#4############'),
(2,26,'29#30#############'),
(2,27,'10#100#400############'),
(2,28,'10#20#400############'),
(2,30,'bank3#newyork#23############'),
(2,30,'tech2##11############'),
(2,31,'tech2##380000############'),
(2,32,'anytimeanywherecrypto#619000#29############'),
(2,33,'11#6000#1000############'),
(2,33,'17#61000#5000############'),
(2,34,'13#9000#2000############'),
(2,34,'23#24000#3000############'),
...
(3,11,'2#1#1000#27000###########'),
(3,11,'3#1#1000#16000###########'),
(3,11,'10#2#1000#15000###########'),
(3,11,'20#1#3000#24000###########'),
(3,11,'30#1#1000#21000###########'),
(3,11,'55#1#1000#29000###########'),
(3,12,'1#1#1000#10000###########'),
(3,12,'2#2#2000#58000###########'),
(3,12,'3#1#1000#16000###########'),
(3,12,'10#2#5000#70000###########'),
(3,12,'20#1#3000#24000###########'),
(3,12,'30#1#1000#21000###########'),
(3,12,'55#2#3000#95000###########'),
(3,13,'1#1#1000#10000###########'),
(3,13,'2#2#2000#58000###########'),
(3,13,'3#1#1000#16000###########'),
(3,13,'10#2#2000#15000###########'),
(3,13,'20#1#3000#24000###########'),
(3,13,'30#1#1000#21000###########'),
(3,13,'55#2#3000#95000###########'),
(3,14,'1#1#1000#10000###########'),
(3,14,'2#2#1000#58000###########'),
(3,14,'3#1#1000#16000###########'),
(3,14,'10#2#1000#15000###########'),
(3,14,'20#1#3000#24000###########'),
(3,14,'30#1#1000#21000###########'),
(3,14,'55#1#1000#29000###########'),
(3,15,'2#1#2000#31000###########'),
(3,15,'10#2#2000#70000###########'),
(3,15,'20#1#3000#24000###########'),
(3,15,'55#1#3000#66000###########'),
(3,16,'1#1#1000#10000###########'),
(3,16,'2#1#1000#27000###########'),
(3,16,'3#1#1000#16000###########'),
(3,16,'10#1#1000#6000###########'),
(3,16,'30#1#1000#21000###########'),
(3,16,'55#1#1000#29000###########'),
(3,17,'alice#123456789#8############'),
(3,17,'michael#123456789#6############'),
(3,18,'alice#123456789#4############'),
(3,18,'michael#123456789#5############'),
(3,18,'alice#333445555#5############'),
(3,18,'ariel#378990405#5############'),
(3,18,'ariel#378990405#9############'),
(3,19,'10#1#170000############'),
(3,19,'0#5#516000############'),
(3,19,'5#9#100000############'),
(3,20,'tech3#houston#850000############'),
(3,21,'bank2#tempestbank#200000#3###########'),
(3,21,'bank3#creditunionuniversal#417000#23###########'),
(3,21,'mgmt2#shelloil&gas#415000#37###########'),
(3,22,'1#12#100############'),
(3,22,'2#30#100############'),
(3,22,'10#4#400############'),
(3,22,'10#20#100############'),
...
(3,23,'1#12#100############'),
(3,23,'10#4#400############'),
(3,24,'10#dronetrafficcontrol#############'),
(3,24,'20#cloudconversion#############'),
(3,24,'55#dataflowgraphanalysis#############'),
(3,25,'666884444#13#9############'),
(3,25,'701294005#5#10############'),
(3,25,'888665555#15#4############'),
(3,25,'987654321#11#4############'),
...
(3,29,'2#1#30############'),
(3,29,'55#2#15############'),
(3,30,'bank3#newyork#23############'),
(3,30,'mgmt1#dallas#7############'),
(3,30,'mgmt2#lubbock#37############'),
(3,30,'tech2##11############'),
(3,31,'bank1#dallas#350000############'),
(3,31,'mgmt1#dallas#############'),
(3,31,'tech2##380000############'),
(3,32,'anytimeanywherecrypto#619000#29############'),
(3,32,'power,water&copper##7############'),
(3,33,'2#10000#1000############'),
(3,33,'7#16000#1000############'),
(3,33,'11#6000#1000############'),
(3,33,'17#61000#5000############'),
...
(4,11,'3#1#1000#12000###########'),
(4,11,'10#2#1000#3000###########'),
(4,11,'20#1#3000#25000###########'),
(4,11,'30#1#1000#20000###########'),
(4,12,'2#2#2000#48000###########'),
(4,12,'3#1#1000#12000###########'),
(4,12,'10#1#5000#59000###########'),
(4,12,'20#1#3000#25000###########'),
(4,12,'30#1#1000#20000###########'),
(4,13,'1#1#1000#6000###########'),
(4,13,'2#2#2000#48000###########'),
(4,13,'3#1#1000#12000###########'),
(4,13,'10#2#2000#3000###########'),
(4,13,'20#1#3000#25000###########'),
(4,13,'30#1#1000#20000###########'),
(4,14,'1#1#1000#6000###########'),
(4,14,'2#2#1000#48000###########'),
(4,14,'3#1#1000#12000###########'),
(4,14,'10#3#1000#62000###########'),
(4,14,'20#1#3000#25000###########'),
(4,14,'30#1#1000#20000###########'),
(4,15,'2#1#2000#29000###########'),
(4,15,'10#2#2000#62000###########'),
(4,15,'20#1#3000#25000###########'),
(4,16,'1#1#1000#6000###########'),
(4,16,'2#1#1000#19000###########'),
(4,16,'3#1#1000#12000###########'),
(4,16,'10#1#1000#0###########'),
(4,16,'30#1#1000#20000###########'),
(4,17,'alice#123456789#8############'),
(4,17,'michael#123456789#5############'),
(4,18,'alice#123456789#4############'),
(4,18,'michael#123456789#5############'),
(4,18,'alice#333445555#5############'),
(4,19,'10#1#160000############'),
(4,19,'0#5#506000############'),
(4,20,'tech3#houston#840000############'),
(4,21,'bank2#tempestbank#220000#3###########'),
(4,21,'bank3#creditunionuniversal#417000#23###########'),
(4,22,'1#12#200############'),
(4,22,'2#30#200############'),
(4,22,'10#4#400############'),
(4,22,'10#20#300############'),
(4,23,'10#4#400############'),
(4,24,'10#dronetrafficcontrol#############'),
(4,24,'20#cloudconversion#############'),
(4,25,'666884444#13#9############'),
(4,25,'888665555#15#4############'),
(4,25,'987654321#11#4############'),
(4,26,'3#2#############'),
...
(4,29,'1#4#12############'),
(4,29,'2#1#30############'),
(4,30,'bank3#newyork#23############'),
(4,30,'mgmt1#dallas#7############'),
(4,30,'tech2##11############'),
(4,31,'bank1#dallas#360000############'),
(4,31,'mgmt1#dallas#############'),
(4,31,'tech2##370000############'),
(4,32,'anytimeanywherecrypto#649000#29############'),
(4,32,'power,water&copper##7############'),
(4,33,'2#6000#1000############'),
(4,33,'3#19000#1000############'),
(4,33,'7#12000#1000############'),
(4,33,'11#0#1000############'),
